...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    ...[...(await publicPatterns()), ...(await publicChineseCollection())].map((pattern) => ({ url: `${base}/patterns/${pattern.slug}`, lastModified: now, changeFrequency: "monthly" as const, priority: .7 })),
